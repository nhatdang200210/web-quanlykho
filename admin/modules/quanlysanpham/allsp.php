...
<?php
$sql_lietke_sanpham = "SELECT * FROM tbl_sanpham,tbl_danhmuc, tbl_ncc 
                        WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc
                        AND tbl_ncc.id_ncc = tbl_sanpham.id_ncc 
                        AND tbl_sanpham.giasanpham != 0 
                        ORDER BY id_sanpham DESC";
$query_lietke_sanpham = mysqli_query($mysqli, $sql_lietke_sanpham);

$sql_sanpham = "SELECT COUNT(id_sanpham) AS dem FROM tbl_sanpham,tbl_danhmuc WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc ORDER BY id_sanpham DESC";
...
<div class="table-responsive lk_sp">
    ...
    <div class="add_sp font">
        <a href="index.php?action=quanlysanpham&query=them">
            <button class="btn btn-primary" style="margin: 0% 0% 1%; padding: 6px 18px; font-size:20px">Thêm sản phẩm <i class="fa-solid fa-tv"></i></button>
        </a>
    </div>
    ...
    <table class="table table-hover table-bordered">
        <thead class="thead-dark font" style="text-align: center; font-size:20px">
            <tr>
                ...
                <th scope="col" class="none" style="width:13%">Danh mục</th>
                <th scope="col" class="none" style="width:15%">Nhà cung cấp</th>
            ...
            ?>
                <tr>
                    ...
                    <td style="width:20%; text-align:center; vertical-align: middle;">
                        <img src="modules/quanlysanpham/uploads/<?php echo $row['avt'] ?>" width="50%" style="border-radius:20px" alt="hình sản phẩm">
                        <div class="ten_sp">
                    ...
                    <td style="text-align: center;vertical-align: middle;">
                        <a href="?action=quanlysanpham&query=sua&idsanpham=<?php echo $row['id_sanpham'] ?>">
                            <button class="btn btn-outline-primary btnsp" style="margin-right:2%; padding: 6px 14px; margin-top:10px">Sửa</button>
                        </a>
                        <button class="btn btn-outline-danger btnsp" onclick="confirmDelete(<?php echo $row['id_sanpham']; ?>)" style="margin-right:2%; padding: 6px 14px; margin-top:10px">Xoá</button>
